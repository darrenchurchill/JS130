 ...
 * elements of an array by examining the array values. You don't have to support
 * multiple arguments to the callback function, but feel free to add them if you
 * like.
 *
